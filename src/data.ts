...
export const providerCatalogs: Record<string, CatalogItem[]> = {
  ...
  "Prime Video": [
    ...
    },
    {
      ...
      synopsis: "Quando o policial militar aposentado Jack Reacher é preso por um assassinato que não cometeu, ele se vê no meio de uma trama mortal cheia de policiais corruptos, empresários obscuros e políticos conspiradores.",
      year: 2024,
      rating: "18",
      duration: "2 Temporadas",
      match: 97,
