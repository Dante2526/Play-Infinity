...
export const INITIAL_LIVE_CHANNELS: LiveChannel[] = [
  ...
  // --- VARIEDADES (+18) ---
  {
    ...
    quality: 'HD',
    description: 'Canal adulto (+18).',
    servers: [
      { name: 'Servidor Oficial', url: 'http://live.redtraffic.xyz/interracial.m3u8', isProxy: false },
      { name: 'Servidor Proxy', url: 'http://live.redtraffic.xyz/interracial.m3u8', isProxy: true }
    ]
  },
  {
    id: 'youporn-tv',
    ...
    description: 'Canal adulto (+18).',
    servers: [
      { name: 'Servidor Oficial', url: 'http://live.redtraffic.xyz/russian.m3u8', isProxy: false },
      { name: 'Servidor Proxy', url: 'http://live.redtraffic.xyz/russian.m3u8', isProxy: true }
    ]
  },
  {
    id: 'sextation',
    ...
    description: 'Canal adulto (+18).',
    servers: [
      { name: 'Servidor Oficial', url: 'http://live.redtraffic.xyz/cuckold.m3u8', isProxy: false },
      { name: 'Servidor Proxy', url: 'http://live.redtraffic.xyz/cuckold.m3u8', isProxy: true }
    ]
  },
  {
    id: 'juice-tv',
    ...
    description: 'Canal adulto (+18).',
    servers: [
      { name: 'Servidor Oficial', url: 'http://live.redtraffic.xyz/bigass.m3u8', isProxy: false },
      { name: 'Servidor Proxy', url: 'http://live.redtraffic.xyz/bigass.m3u8', isProxy: true }
    ]
  },
  {
    id: 'dusk-tv',
    ...
    description: 'Canal adulto (+18).',
    servers: [
      { name: 'Servidor Oficial', url: 'http://live.redtraffic.xyz/milf.m3u8', isProxy: false },
      { name: 'Servidor Proxy', url: 'http://live.redtraffic.xyz/milf.m3u8', isProxy: true }
    ]
  },
  {
    id: 'hot-tv',
    ...
    description: 'Canal adulto (+18).',
    servers: [
      { name: 'Servidor Oficial', url: 'http://live.redtraffic.xyz/blowjob.m3u8', isProxy: false },
      { name: 'Servidor Proxy', url: 'http://live.redtraffic.xyz/blowjob.m3u8', isProxy: true }
    ]
  }
];
